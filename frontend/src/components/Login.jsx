...
function Login() {
    ...
    return (
        <>
            ...
            {isMobile ? (
                <Container style={{ width: '90%', padding: '20px',  margin:'auto', objectFit:'scale-down !important', borderRadius: '15px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.2)' }}>
                    <img src={img} alt="logo" style={{ width: '80px', borderRadius: '50%', marginBottom: '10px' }} />
                    {account === 'login' ? (
                        <>
                            <InputField label="Username" variant="outlined" />
                            <InputField label="Password" variant="outlined" type="password" />
                            <ButtonStyled>Login</ButtonStyled>
                            <Typography variant="body2" style={{ color: 'white', marginTop:'25px' }}>OR</Typography>
                            <ToggleButton onClick={() => setAccount('signup')}>Create an account</ToggleButton>
                        </>
                    ) : (
                        <>
                            ...
                            <Typography variant="body2" style={{ color: 'white', marginTop:'25px' }}>OR</Typography>
                            <ToggleButton onClick={() => setAccount('login')}>Already have an account?</ToggleButton>
                        </>
                    )}
                </Container>
            ) : (
